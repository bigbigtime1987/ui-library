...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to &quot;基本用法&quot;">​</a></h2>`,7),h=n("pre",null,[n("code",{class:"language-html"},`<template>
    <a-space :size="20">
        <a-icon :size="16">
            <XCircle />
        </a-icon>
...
<\/script>`)],-1),v=n("div",{class:"language-html vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"html"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"icons/basis")])])])],-1),z=n("h2",{id:"尺寸",tabindex:"-1"},[e("尺寸 "),n("a",{class:"header-anchor",href:"#尺寸","aria-label":'Permalink to "尺寸"'},"​")],-1),m=n("pre",null,[n("code",{class:"language-html"},`<template>
    <a-space :size="20">
        <a-icon :size="24">
            <CheckCircle />
        </a-icon>
...
<\/script>`)],-1),k=n("div",{class:"language-html vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"html"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"icons/size")])])])],-1),g=n("h2",{id:"system",tabindex:"-1"},[e("System "),n("a",{class:"header-anchor",href:"#system","aria-label":'Permalink to "System"'},"​")],-1),C=n("pre",null,[n("code",{class:"language-html"},`<template>
    <ul class="icons-list">
        <li>
            <div>
...
import { ref } from "vue"
const size = ref(20)
<\/script>`)],-1),u=n("div",{class:"language-html vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"html"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"icons/system")])])])],-1),E=n("h2",{id:"arrow",tabindex:"-1"},[e("Arrow "),n("a",{class:"header-anchor",href:"#arrow","aria-label":'Permalink to "Arrow"'},"​")],-1),f=n("pre",null,[n("code",{class:"language-html"},`<template>
    <ul class="icons-list">
        <li>
            <div>
...
import { ref } from "vue"
const size = ref(20)
<\/script>`)],-1),y=n("div",{class:"language-html vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"html"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"icons/arrow")])])])],-1);function w(A,_,b,D,F,L){const s=c("Demo");return t(),o("div",null,[r,a(s,{path:"icons/basis"},{source:i(()=>[h]),description:i(()=>[]),default:i(()=>[v]),_:1}),z,a(s,{path:"icons/size"},{source:i(()=>[m]),description:i(()=>[]),default:i(()=>[k]),_:1}),g,a(s,{path:"icons/system"},{source:i(()=>[C]),description:i(()=>[]),default:i(()=>[u]),_:1}),E,a(s,{path:"icons/arrow"},{source:i(()=>[f]),description:i(()=>[]),default:i(()=>[y]),_:1})])}const S=l(d,[["render",w]]);export{R as __pageData,S as default};
