...
</style>`)],-1),$=n("p",null,[l("通过 "),n("code",null,"order"),l(" 来改变元素的排序。")],-1),A=n("div",{class:"language-html vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"html"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[n("code",null,[n("span",{class:"line"},[n("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"gird/order")])])])],-1),B=s("",4);function G(I,W,F,J,O,H){const a=d("Demo");return i(),c("div",null,[g,h,p,u,o(a,{path:"gird/basis"},{source:t(()=>[b]),description:t(()=>[v]),default:t(()=>[m]),_:1}),f,o(a,{path:"gird/gutter"},{source:t(()=>[k]),description:t(()=>[_]),default:t(()=>[x]),_:1}),y,o(a,{path:"gird/gap"},{source:t(()=>[w]),description:t(()=>[C]),default:t(()=>[E]),_:1}),P,o(a,{path:"gird/offset"},{source:t(()=>[j]),description:t(()=>[S]),default:t(()=>[N]),_:1}),T,o(a,{path:"gird/align"},{source:t(()=>[V]),description:t(()=>[R]),default:t(()=>[q]),_:1}),z,o(a,{path:"gird/order"},{source:t(()=>[D]),description:t(()=>[$]),default:t(()=>[A]),_:1}),B])}const M=e(r,[["render",G]]);export{L as __pageData,M as default};
